...
#На основе рассмотренного на лекции примера реализуйте алгоритм 
# Policy Iteration для любой среды обучения с подкреплением 
# (кроме рассмотренной на лекции среды Toy Text / Frozen Lake) 
